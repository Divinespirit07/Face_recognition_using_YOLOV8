...
# Function to detect humans and extract faces using YOLO with confidence threshold
def detect_and_extract_faces(frame):
    frame_resized = cv2.resize(frame, (640, 480))

    # ⚠️ Set optimal confidence threshold based on F1 analysis
    results = yolo_model(frame_resized, conf=0.415)
...
# Function to prompt for name and ID (GUI)
